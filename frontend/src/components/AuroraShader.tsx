...
const AuroraShader: React.FC = () => {
  ...
  return (
    <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none bg-[#020205]">
      <canvas 
        ref={canvasRef} 
        className="absolute inset-0 w-full h-full block"
      />
      {/* 底部渐变遮罩，增强地面对比度 */}
      <div className="absolute inset-0 z-10 bg-gradient-to-t from-[#020205] via-transparent to-transparent opacity-60" />
    </div>
  );
};
